...
public class TargetBean3 {
    ...
    @Autowired(required = false)
    public TargetBean3(PropsBean1 propsBean1){
        this.propsBean1 = propsBean1;
    }

    @Autowired(required = false)
    public TargetBean3(PropsBean2 propsBean2){
        this.propsBean2 = propsBean2;
    }

    @Autowired(required = false)
    public TargetBean3(PropsBean1 propsBean1, PropsBean2 propsBean2){
        log.info("{}", "采用此处的构造函数");
        this.propsBean1 = propsBean1;
        this.propsBean2 = propsBean2;
    }
